...
import { $eq, $in, $is_me, $neq, $nin } from '../../../filter/operators.js'

export const createdByFilterOperators = z.union([$eq, $neq, $in, $nin, $is_me])
export type ICreatedByFilterOperator = z.infer<typeof createdByFilterOperators>

export const createdByFilterValue = userIdSchema.or(userIdSchema.array())
