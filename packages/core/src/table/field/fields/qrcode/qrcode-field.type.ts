...
export const createQRCodeFieldSchema = createBaseFieldSchema.merge(qrcodeTypeObjectSchema)
export type ICreateQRCodeFieldInput = z.infer<typeof createQRCodeFieldSchema>

export const updateQRCodeFieldSchema = updateBaseFieldSchema.merge(qrcodeTypeObjectSchema)
export type IUpdateQRCodeFieldInput = z.infer<typeof updateQRCodeFieldSchema>

export const qrcodeFieldQuerySchema = baseFieldQuerySchema.merge(qrcodeTypeObjectSchema)
