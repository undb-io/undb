  ...
  resources: {
    en: {
      ...
      event: {
        ...
        'record.buld_created': 'record buld created',
        'record.buld_updated': 'record buld updated',
        'record.buld_deleted': 'record buld deleted',
      },
      zod: zodEn,
    },
    'zh-CN': {
      ...
      event: {
        ...
        'record.updated': '行更新',
        'record.deleted': '行删除',
        'record.buld_created': '批量行创建',
        'record.buld_updated': '批量行更新',
        'record.buld_deleted': '批量行删除',
      },
      zod: zodZh,
    },
  },
