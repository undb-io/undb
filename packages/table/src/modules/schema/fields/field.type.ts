...
export type Field = StringField | NumberField | IdField
export type FieldValue = StringFieldValue | NumberFieldValue | IdFieldValue
export type FieldType = typeof STRING_TYPE | typeof NUMBER_TYPE | typeof ID_TYPE
