...
import { DurationFieldValue } from "./duration-field-value.vo"

export class DurationEqual extends RecordComositeSpecification {
  constructor(
  ...
  mutate(t: RecordDO): Result<RecordDO, string> {
    t.values.setValue(this.fieldId, new DurationFieldValue(this.value))
    return Ok(t)
  }
  accept(v: IRecordVisitor): Result<void, string> {
    v.durationEqual(this)
    return Ok(undefined)
  }
}
