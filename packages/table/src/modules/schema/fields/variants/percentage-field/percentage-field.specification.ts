...
import { PercentageFieldValue } from "./percentage-field-value.vo"

export class PercentageEqual extends RecordComositeSpecification {
  constructor(
  ...
  mutate(t: RecordDO): Result<RecordDO, string> {
    t.values.setValue(this.fieldId, new PercentageFieldValue(this.value))
    return Ok(t)
  }
  accept(v: IRecordVisitor): Result<void, string> {
    v.percentageEqual(this)
    return Ok(undefined)
  }
}
