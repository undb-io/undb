...
export const fieldTypes: NoneSystemFieldType[] = ["string", "number", "reference", "rollup", "select"] as const
...
export const fieldsCanBeRollup: FieldType[] = ["number", "string"] as const
