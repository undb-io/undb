	...
	>
		<span
			class={cn(
				...
				'border-gray-200 group-hover/table:border-primary group-hover/table:text-primary dark:border-white dark:group-hover/table:border-gray-50 dark:group-hover/table:text-gray-50 transition',
