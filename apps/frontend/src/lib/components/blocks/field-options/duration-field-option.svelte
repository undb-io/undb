...
<div class="space-y-2">
  ...
  {#if constraint}
    <div class="grid grid-cols-2 gap-2">
      <div class="space-y-1">
        <Label for="min" class="text-xs font-normal">{$LL.table.field.duration.min()}</Label>
        <NumberInput
          {disabled}
          id="min"
          min={0}
          ...
          placeholder={$LL.table.field.duration.minPlaceholder()}
          class="bg-background text-xs"
        />
      </div>
      <div class="space-y-1">
        <Label for="max" class="text-xs font-normal">{$LL.table.field.duration.max()}</Label>
        <NumberInput
          {disabled}
          id="max"
          ...
          placeholder={$LL.table.field.duration.maxPlaceholder()}
          class="bg-background text-xs"
        />
      </div>
    </div>
