...
import type { ICreateRecordInput } from '@undb/cqrs'
import { useCreateRecordMutation } from '@undb/store'
import { Alert, Box, Button, Group, IconAlertCircle, IconPlus, openContextModal, Space, Stack } from '@undb/ui'
