import type { ICreateTreeFieldSchema } from '@undb/core'
import { FieldId } from '@undb/core'
import { createTreeFieldSchema } from '@undb/core'
import { useCreateFieldMutation, useSetTreeFieldMutation } from '@undb/store'
import { Button, Card, Group, IconChevronLeft, Stack, Text, TextInput } from '@undb/ui'
